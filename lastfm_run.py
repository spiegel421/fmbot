...
async def fm(ctx):
    ...
    embed = discord.Embed(colour=0xFF0000, title=now_playing.artist.name, description=now_playing.title, url="https://rateyourmusic.com/search?searchtype=a&searchterm="+now_playing.artist.name)
